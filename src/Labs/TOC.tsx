...
export default function TOC() {
    ...
    return (
        <><h3>Tara Standard <br /> CS4550 Sec 02</h3><br />
            <Nav variant="pills" id="wd-toc">
                ...
                <Nav.Item> <Nav.Link id="wd-github1" href="https://github.com/standard-t/kambaz-web-app-cs4550/tree/a6" target="_blank">Front-end GitHub</Nav.Link> </Nav.Item>
                <Nav.Item> <Nav.Link id="wd-github2" href="https://github.com/standard-t/kambaz-node-server-app/tree/a6" target="_blank">Back-end GitHub</Nav.Link> </Nav.Item>
                <Nav.Item> <Nav.Link id="wd-server" href="https://kambaz-node-server-app-uxal.onrender.com/" target="_blank">On-render database</Nav.Link> </Nav.Item>
            </Nav ></>
    );
}
