...
export default function KambazNavigation() {
    return (
        <ListGroup className="rounded-0 z-2 d-none d-md-block bg-black position-fixed top-0 bottom-0 left-0">
            ...
            <ListGroup.Item className="bg-black text-white border-0 text-center" as={Link} to="/Kambaz/Account/Account"><RiAccountCircleLine className="fs-1" /> <br /> Account</ListGroup.Item>
